...
public class ProxyServer {
	...
	public void player() {
		this.setParts(Human.class, API.body, API.head, API.headwear, API.rightArm, API.leftArm, API.rightLeg, API.leftLeg, API.ears, API.cloak);
		this.setSpecial(Human.class, HumanAPI.class, HumanSpecial.class);
	}

	public void wolf() {
		this.setParts(EntityWolf.class, API.body, API.head, API.backRightLeg, API.backLeftLeg, API.frontRightLeg, API.frontLeftLeg, API.tail, API.mane);
		this.setSpecial(EntityWolf.class, WolfAPI.class, WolfSpecial.class);
	}

	public void creeper() {
		this.setParts(EntityCreeper.class, API.body, API.head, API.backRightLeg, API.backLeftLeg, API.frontRightLeg, API.frontLeftLeg, "");
